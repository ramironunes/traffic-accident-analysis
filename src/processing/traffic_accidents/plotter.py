...
class TrafficAccidentPlotter:
    ...
    def plot_accident_cause(
        ...
        output_path = os.path.join(
            self.output_dir, 
            f'{dataset_name}_accident_cause_distribution.png'
        )
        self.ensure_directory_exists(os.path.dirname(output_path))
        plt.savefig(output_path)
        plt.close()

    def plot_accident_density(
        self, data: pd.DataFrame, dataset_name: str
    ) -> None:
        """
        ...
        output_path = os.path.join(
            self.output_dir, 
            f'{dataset_name}_accident_density_map.png'
        )
        self.ensure_directory_exists(os.path.dirname(output_path))
        plt.savefig(output_path)
        plt.close()
    ...
    def plot_static_map(
        self, shapefile_path: str, dataset_name: str
    ) -> None:
        """
        ...
        output_path = os.path.join(
            self.output_dir, 
            f'{dataset_name}_static_map.png'
        )
        self.ensure_directory_exists(os.path.dirname(output_path))
        plt.savefig(output_path)
        plt.close()
    ...
    def plot_vehicle_type(
        ...
        output_path = os.path.join(
            self.output_dir, 
            f'{dataset_name}_vehicle_type_distribution.png'
        )
        self.ensure_directory_exists(os.path.dirname(output_path))
        plt.savefig(output_path)
        plt.close()
    ...
    def plot_weather_condition(
        ...
        output_path = os.path.join(
            self.output_dir, 
            f'{dataset_name}_weather_condition_distribution.png'
        )
        self.ensure_directory_exists(os.path.dirname(output_path))
        plt.savefig(output_path)
        plt.close()
